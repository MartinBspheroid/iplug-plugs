...
def main():
  ...
  plistpath = scriptpath + "/resources/SRC-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRC-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRC-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRC-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SRC-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SRC.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SRC.iss",inplace=1):
