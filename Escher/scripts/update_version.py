...
def main():
  ...
  plistpath = scriptpath + "/resources/Escher-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Escher-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Escher-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Escher-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Escher-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Escher.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Escher.iss",inplace=1):
