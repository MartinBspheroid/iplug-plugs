...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Escher Demo Installer\n"
      else:
        line="OutputBaseFilename=Escher Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Escher Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Escher installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Escher Demo installer\n"
     else:
       line="SetupWindowTitle=Escher installer\n"
