...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=SmokeSwitchControl Demo Installer\n"
      else:
        line="OutputBaseFilename=SmokeSwitchControl Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the SmokeSwitchControl Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the SmokeSwitchControl installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=SmokeSwitchControl Demo installer\n"
     else:
       line="SetupWindowTitle=SmokeSwitchControl installer\n"
