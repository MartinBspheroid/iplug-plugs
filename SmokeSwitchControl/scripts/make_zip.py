...
def  main():
  ...
  installer = "\installer\SmokeSwitchControl Installer.exe"
   
  if demo:
    installer = "\installer\SmokeSwitchControl Demo Installer.exe"
   
  FILES_TO_ZIP = [
    projectpath + installer,
    projectpath + "\installer\changelog.txt",
    projectpath + "\installer\known-issues.txt",
    projectpath + "\manual\SmokeSwitchControl manual.pdf" 
  ]
  ...
  ZIPNAME = "SmokeSwitchControl-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "SmokeSwitchControl-v" + FULLVERSIONSTR + "-win-demo.zip"
