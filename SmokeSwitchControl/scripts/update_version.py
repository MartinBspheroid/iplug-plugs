...
def main():
  ...
  plistpath = scriptpath + "/resources/SmokeSwitchControl-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SmokeSwitchControl-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SmokeSwitchControl-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SmokeSwitchControl-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/SmokeSwitchControl-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/SmokeSwitchControl.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/SmokeSwitchControl.iss",inplace=1):
