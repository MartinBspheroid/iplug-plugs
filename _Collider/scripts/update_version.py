...
def main():
  ...
  plistpath = scriptpath + "/resources/Collider-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Collider-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Collider-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Collider-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Collider-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Collider.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Collider.iss",inplace=1):
