...
__m128 VecAmalgam::bitHack(const __m128& x, const __m128& y, float paramA, float paramB) {
    ...
    __c32 = _mm_and_si128(__c32, _mm_andnot_si128(_mm_andnot_si128(__a32, __b32), _mm_castps_si128(__chance32))); // Make 0 if a == 0 AND b == 0
    // original _> +>>>>>> __c32 = _mm_and_si128(__c32, ~_mm_and_si128(_mm_and_si128(~__a32, ~__b32), _mm_castps_si128(__chance32))); // Make 0 if a == 0 AND b == 0
