...
def main():
  ...
  plistpath = scriptpath + "/resources/Corridor-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Corridor-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Corridor-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Corridor-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Corridor-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Corridor.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Corridor.iss",inplace=1):
