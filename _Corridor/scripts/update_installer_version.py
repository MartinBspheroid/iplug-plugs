...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Corridor Demo Installer\n"
      else:
        line="OutputBaseFilename=Corridor Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Corridor Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Corridor installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Corridor Demo installer\n"
     else:
       line="SetupWindowTitle=Corridor installer\n"
