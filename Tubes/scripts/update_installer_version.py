...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Tubes Demo Installer\n"
      else:
        line="OutputBaseFilename=Tubes Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Tubes Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Tubes installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Tubes Demo installer\n"
     else:
       line="SetupWindowTitle=Tubes installer\n"
