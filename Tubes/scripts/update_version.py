...
def main():
  ...
  plistpath = scriptpath + "/resources/Tubes-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tubes-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tubes-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tubes-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Tubes-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Tubes.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Tubes.iss",inplace=1):
