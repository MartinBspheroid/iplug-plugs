...
def main():
  ...
  plistpath = scriptpath + "/resources/Revolver-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Revolver-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Revolver-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Revolver-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Revolver-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Revolver.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Revolver.iss",inplace=1):
