...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Revolver Demo Installer\n"
      else:
        line="OutputBaseFilename=Revolver Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Revolver Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Revolver installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Revolver Demo installer\n"
     else:
       line="SetupWindowTitle=Revolver installer\n"
