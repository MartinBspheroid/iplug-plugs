...
def main():
  ...
  plistpath = scriptpath + "/resources/FooBar-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FooBar-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FooBar-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FooBar-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FooBar-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/FooBar.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FooBar.iss",inplace=1):
