...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=FooBar Demo Installer\n"
      else:
        line="OutputBaseFilename=FooBar Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the FooBar Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the FooBar installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=FooBar Demo installer\n"
     else:
       line="SetupWindowTitle=FooBar installer\n"
