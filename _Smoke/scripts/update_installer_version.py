...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Smoke Demo Installer\n"
      else:
        line="OutputBaseFilename=Smoke Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Smoke Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Smoke installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Smoke Demo installer\n"
     else:
       line="SetupWindowTitle=Smoke installer\n"
