...
def main():
  ...
  plistpath = scriptpath + "/resources/Smoke-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Smoke-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Smoke-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Smoke-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Smoke-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Smoke.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Smoke.iss",inplace=1):
